...
for i in  Govs :
    ...
    i.Service_Ratio()
    i.Calc_Density_Classification()
    i.Calc_Growth_Rate_Classification()
    i.Calc_Risk_Analysis()
    i.Future_Service()
    i.Show_Info()
    ...
    print(i.Density_State)
    print(i.Growth_Rate_State)
    print(i.Risk_State)
    print(i.Future_School_Number)
    print(i.Future_Hospital_Number)
    print(i.Future_Police_Number)
    print(i.Future_Ambulance_Number)
    print(i.Future_Fire_Station_Number)
